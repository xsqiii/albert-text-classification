...
flags.DEFINE_enum("classification_task_name", "sentiment",
                  ["COLA", "STS", "SST", "MNLI", "QNLI",
                      "QQP", "RTE", "MRPC", "WNLI", "XNLI", "sentiment"],
...
flags.DEFINE_string("spm_model_file", "./albert_tiny/vocab.txt",
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "train_data_output_path", "./tf_record_dir/train.tf_record",
    "The path in which generated training input data will be written as tf"
    " records."
)

flags.DEFINE_string(
    "eval_data_output_path", "./tf_record_dir/eval.tf_record",
    "The path in which generated eval input data will be written as tf"
    " records."
)

flags.DEFINE_string(
    "test_data_output_path", "./tf_record_dir/test.tf_record",
    "The path in which generated test input data will be written as tf"
    " records."
)

flags.DEFINE_string("meta_data_file_path", "./tf_record_dir/meta_data",
...
def generate_classifier_dataset():
    ...
    # return classifier_data_lib.generate_test_tf_record_from_data_file(
    #     processor,
    #     FLAGS.input_data_dir,
    #     FLAGS.spm_model_file,
